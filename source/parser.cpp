...
BOOST_FUSION_ADAPT_STRUCT(idl::Union, documentation, identifier, fields);
...
const x3::rule<struct Union, idl::Union> union_("Union");
...
const auto definition_def = const_ | typedef_ | enum_ | struct_ | union_ | exception | service;
